summon cat ~ ~1 ~ {Invulnerable:1b, variant:"minecraft:all_black", CustomName: '{"bold":true, "translate":"entity.konosuba.megumin.chomusuke.name", "color":"dark_red"}', Tags: ["konosuba.chomusuke", "konosuba.chomusuke_init"], DeathLootTable: "minecraft:empty"}
