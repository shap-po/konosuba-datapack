...
#define score_holder $godLives [0..] - Number of additional lives a god player starts with
execute unless score $godLives konosuba.gamerule matches 0.. run scoreboard players set $godLives konosuba.gamerule 1
